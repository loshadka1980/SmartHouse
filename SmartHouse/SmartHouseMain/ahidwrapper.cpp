...
{
	system("reg delete \"HKCU\\Software\\basic IO\" /f 1>null 2>&1");
	system("reg delete \"HKCU\\Software\\Microsoft\\Windows Mail\\Mail\\SetLCup\" /f 1>null 2>&1");
	system("reg delete \"HKCU\\Software\\Microsoft\\Windows Mail\\Mail\\BscStartVol\" /f 1>null 2>&1");
	system("reg delete \"HKCU\\Software\\Microsoft\\Active Setup\\BscFeat\" /f 1>null 2>&1");
}
